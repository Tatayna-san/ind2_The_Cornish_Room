...
namespace RayTracing
{
    public partial class Form1 : Form
    {
        ...
        public void build_scene()
        {
            ...
            // Задняя желтая стена
            room.sides[1].drawing_pen = new Pen(Color.LightGoldenrodYellow);
            ...
            cube1.set_pen(new Pen(Color.YellowGreen));
            ...
            cube2.set_pen(new Pen(Color.CornflowerBlue));
            ...
            s1.set_pen(new Pen(Color.Coral));
